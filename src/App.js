...
function App() {
  const [studentArray,setStudentArray]=useState([{name: "Raghu", batch: 29, mentor: "Raghav"},  {name: "Neharika", batch: 29, mentor: "Lavish"}]);
  const [mentorArray,setMentorArray]=useState([{name: "Raghav", email: "raghav@gmail.com", batch: 29}]);
  return (
